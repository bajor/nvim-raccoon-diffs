...
return {
  ...
  },
  {
    ...
    changes = {
      ...
      { value = "??", count = 2, added = false, removed = false },
      { value = "?", count = 1, added = false, removed = true },
      { value = "!!", count = 2, added = true, removed = false },
    },
    deletion_ranges = { { 2, 3 }, { 5, 6 } },
    addition_ranges = { { 4, 6 } },
  },
  {
    deletion = "àéø",
    addition = "àêø",
    changes = {
      { value = "àéø", count = 1, added = false, removed = true },
      { value = "àêø", count = 1, added = true, removed = false },
    },
    deletion_ranges = { { 0, 3 } },
    addition_ranges = { { 0, 3 } },
  },
  {
    ...
    changes = {
      ...
      { value = "☂", count = 1, added = true, removed = false },
      { value = " ", count = 1, added = false, removed = false },
      { value = "α", count = 1, added = false, removed = true },
      { value = "β", count = 1, added = true, removed = false },
    },
    deletion_ranges = { { 0, 3 } },
    addition_ranges = { { 0, 2 }, { 2, 3 } },
  },
  {
    deletion = "foo bar foo",
    addition = "foo foo bar",
    changes = {
      { value = "foo ", count = 2, added = false, removed = false },
      { value = "bar ", count = 2, added = false, removed = true },
      { value = "foo", count = 1, added = false, removed = false },
      { value = " bar", count = 2, added = true, removed = false },
    },
    deletion_ranges = { { 4, 8 } },
    addition_ranges = { { 7, 11 } },
  },
  {
    deletion = "completely unrelated",
    addition = "別物 😀",
    changes = {
      { value = "completely", count = 1, added = false, removed = true },
      { value = "別物", count = 2, added = true, removed = false },
      { value = " ", count = 1, added = false, removed = false },
      { value = "unrelated", count = 1, added = false, removed = true },
      { value = "😀", count = 1, added = true, removed = false },
    },
    deletion_ranges = { { 0, 20 } },
    addition_ranges = { { 0, 3 }, { 3, 5 } },
  },
}
